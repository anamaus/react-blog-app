...
const blog = (props) => {
  ...
  return (
    <div className="panel panel-default">
      ...
      <button  className="btn btn-success"  onClick={props.getBlog}>Read more</button>
      <Link to={"/posts/"+props.id} className="btn btn-success" onClick={props.getBlog}>Read more</Link>
